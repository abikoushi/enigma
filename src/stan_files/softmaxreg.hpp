...
public:
    ...
    T__ log_prob(vector<T__>& params_r__,
        ...
        try {
            ...
            Eigen::Matrix<local_scalar_t__,Eigen::Dynamic,Eigen::Dynamic>  Xbeta(static_cast<Eigen::VectorXd::Index>(N),static_cast<Eigen::VectorXd::Index>(K));
            ...
            for (int n = 1; n <= N; ++n) {
                ...
                Eigen::Matrix<local_scalar_t__,Eigen::Dynamic,1>  lp(static_cast<Eigen::VectorXd::Index>(L));
    ...
    void write_array(RNG& base_rng__,
        ...
        try {
            ...
            vector<Eigen::Matrix<local_scalar_t__,Eigen::Dynamic,1> > cate(N, (Eigen::Matrix<local_scalar_t__,Eigen::Dynamic,1> (static_cast<Eigen::VectorXd::Index>(L))));
